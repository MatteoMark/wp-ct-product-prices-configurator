...
<h1><?php echo esc_html__('Pannelli Fotovotlaici GeneralCovers', 'ct-admin'); ?></h1>
<p><?php echo esc_html__('Configuratore pannelli fotovotlaici GeneralCovers', 'ct-admin'); ?></p>
